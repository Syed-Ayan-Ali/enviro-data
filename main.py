...
def website_opener():
    ...
    driver.get("https://www.google.com/maps/place/G-5,+Islamabad,+Islamabad+Capital+Territory,+Pakistan/@33.72064,73.0885383,15z/data=!3m1!4b1!4m5!3m4!1s0x38dfc07b1b153ac9:0x7a6fc13096543e55!8m2!3d33.7218048!4d73.0980773!5m2!1e1!1e4")
    ...
    for sector in Sectors: 
        ...
        info.append(emmisions_calculations(green,orange,red,black))
...
def emmisions_calculations(g,o,r,b):
    ...
    emmisions=((g*formula*0.2)+(o*formula*0.5)+(r*formula*0.8)+(b*formula*0.96))*0.525*0.2*10
...
def send_to_website(data):
    ...
    web_data=''
    for i in info:
        web_data=web_data+'<h4>'+ i +'kg </h4> \n'
    f=open('Website\data.html', "w")
    f.write(starting_html +web_data +ending_html)
    f.close() 
